...
rm -rf "${MODEL_REPO}"
cp -r "${TRTLLM_ROOT}/tensorrt_llm/triton_backend/all_models/whisper" "${MODEL_REPO}"
cp -r \
  "${TRTLLM_ROOT}/tensorrt_llm/triton_backend/all_models/inflight_batcher_llm/tensorrt_llm" \
